...
import com.test.luckydrum.databinding.FragmentSumBetqasdBinding


class SumBetFragmentqasd : Fragment() {
    val binding by lazy{ FragmentSumBetqasdBinding.inflate(layoutInflater)}
    var text = ""

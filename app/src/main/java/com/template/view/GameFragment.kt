...
class GameFragment : Fragment(), GameViewApi {
    ...
    fun clickBonus(){
        ...
        if(firstClick) {
            ...
            val animator2 = ObjectAnimator.ofFloat(binding.CVthree, View.ALPHA, 0F)
            animator2.duration = 500
            animator2.start()

            val animator3 = ObjectAnimator.ofFloat(binding.CVthree, View.ROTATION, -50F)
            animator3.duration = 500
            animator3.start()

            val animator4 = ObjectAnimator.ofFloat(binding.CVthree, View.TRANSLATION_Y, -600F)
            animator4.duration = 500
            animator4.start()

            val animator5 = ObjectAnimator.ofFloat(binding.CVthree, View.TRANSLATION_X, -600F)
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                ...
                val animator3 = ObjectAnimator.ofFloat(binding.CVthree, View.ROTATION, 0F)
                animator3.duration = 0
                animator3.start()

                val animator4 = ObjectAnimator.ofFloat(binding.CVthree, View.TRANSLATION_Y, 0F)
                animator4.duration = 0
                animator4.start()

                val animator5 = ObjectAnimator.ofFloat(binding.CVthree, View.TRANSLATION_X, 0F)
                ...
                if(drawable !== clickDrawableButton) {
                    ...
                    animator2.duration = 500
                    animator2.start()
                    val animator3 = ObjectAnimator.ofFloat(binding.Bblue, View.ALPHA, 0F)
                    animator3.duration = 500
                    animator3.start()
